#ifndef __LesionSegmentationQIBenchCLI_h
#define __LesionSegmentationQIBenchCLI_h
...
class LesionSegmentationQIBenchCLI : public MetaCommand
{
...
public:
  ...
  LesionSegmentationQIBenchCLI( int argc, char *argv[] ) : MetaCommand()
  {
